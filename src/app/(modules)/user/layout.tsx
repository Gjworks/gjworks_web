...
const PageLayout = ({ children }) => {
  ...
  return (
    <DefaultLayout>
      ...
      <div className="flex justify-center sticky top-[52px] lg:top-[56px] w-full bg-gray-100/90 dark:bg-dark-950/40 backdrop-blur-lg z-90 border-b border-gray-200 dark:border-dark-700">
