      ...
      <div className="flex flex-wrap gap-8 px-3 pt-10 pb-20">
        <div className="w-full">
          <div className="max-w-screen-md mx-auto">
            <div className="w-full">
              <div className="relative w-full overflow-hidden rounded-xl border border-gray-200/75 bg-gray-100 dark:bg-dark-900/75 dark:border-dark-700/75 p-5 shadow-lg dark:shadow-black/75 shadow-gray-100/90 backdrop-blur-xl lg:p-10 h-full mb-6">
