    ...
    <MainLayout>
      ...
      <div className="absolute inset-0 overflow-hidden bg-dark-900/90 backdrop-blur-2xl"></div> */}
        ...
        <div className="relative max-w-screen-3xl mx-auto px-0 lg:px-3 pb-20">
              ...
              <div className="relative w-full py-0 lg:py-20 dark:border-0 overflow-hidden ">
                <div className="relative mx-auto max-w-screen-lg gap-8 pt-0">
                  <div className="relative flex items-center justify-center pt-20 pb-[220px] lg:pb-20 lg:col-span-8 z-10">
                    <motion.div variants={parentVariants} initial="offscreen" whileInView="onscreen" viewport={{ once: false, amount: 0.3 }} className="grid w-full grid-cols-12 gap-8">
                      <div className="md:order-0 z-10 order-1 col-span-12 md:col-span-12">
                        <div className="">
                          <div className="relative grid grid-cols-1 gap-1 px-4">
                            <motion.div variants={variants} className="col-span-1 px-1 lg:mb-2">
                              <div className="flex flex-wrap gap-2 text-4xl font-normal md:font-medium !leading-tight tracking-tight text-white lg:text-5xl lg:gap-0 dark:text-white w-full justify-center text-center">Building digital experience ✨</div>
                            </motion.div>

                            <motion.div variants={variants} className="mb-10 pl-0 text-4xl font-normal md:font-medium tracking-tight text-white lg:text-5xl dark:text-white text-center">
                              Creative platform service
                            </motion.div>
                          </div>
                        </div>
                        <div className="w-full px-4">
                          <motion.div variants={variants} className="relative mx-auto mb-6 max-w-lg py-3">
                            <div className="flex gap-8 rounded-full bg-gray-950/50 dark:bg-dark-900/30 p-2 backdrop-blur-lg lg:p-2">
                              <div className="flex flex-1 items-center px-3">
                                <div className="dark:text-dark-400 line-clamp-1 text-sm text-gray-100">Launch Your Service.</div>
                              </div>
                              <button
                                onClick={() => {
                                  setShowPopup(true)
                          ...
                          <motion.div variants={variants} className="relative mx-auto flex items-center justify-center gap-4 px-3 md:w-3/5 lg:w-2/5">
                            ...
                            <div className="flex-1">
                              <div className="dark:text-dark-100 mb-2 text-left text-sm text-gray-50">Various Projects</div>
                              <div className="dark:text-dark-300 text-left text-xs text-gray-400">다양한 프로젝트를 만나보시고 좋은 의견과 아이디어를 주시면 반영하겠습니다.</div>
                            </div>
                          </motion.div>
                        </div>
                      </div>
          ...
          <motion.div initial="offscreen" whileInView="onscreen" viewport={{ once: false, amount: 0.1 }} variants={parentVariants} className="pt-20">
                  ...
                  <div className="flex justify-center">
                    <div className="w-full lg:w-3/5">
                      <motion.div variants={variants} className="flex justify-center mb-6">
                        <span className="border border-gray-200 py-0.5 px-4 rounded-full text-sm text-gray-400">Premium Quality</span>
                      </motion.div>
                      <motion.div variants={variants} className="mb-4 text-xl font-semibold text-black lg:text-4xl dark:text-white text-center !leading-tight tracking-tight">
                        BEST UI TEMPLATES
                      </motion.div>
                      <motion.div variants={variants} className="dark:text-dark-500 text-sm lg:text-base text-gray-500 text-center">
                        컴포넌트는 React와 Next.js에서 사용할 수 있습니다. 모든 Component는 tailwindcss와 Framer motion을 활용하여 애니메이션과 스타일을 정의했습니다.
                      </motion.div>
                    </div>
                  </div>
                </div>
          ...
          <motion.div initial="offscreen" whileInView="onscreen" viewport={{ once: false, amount: 0.1 }} variants={parentVariants} className="py-20 w-full">
                ...
                <div className="flex-1 flex justify-center">
                  <div className="relative flex items-center bg-gray-50/50 dark:bg-dark-950/50 justify-center border border-gray-200/75 dark:border-dark-800/75 rounded-full h-64 md:w-96 w-64 md:h-96 shadow-2xl shadow-gray-100 dark:shadow-dark-900">
                    <div className="flex items-center justify-center border border-gray-200/75 dark:border-dark-800/75 rounded-full w-40 md:w-64 h-40 md:h-64 bg-white/50 dark:bg-black/50">
                      ...
                      <motion.div variants={variants2} className="absolute text-center shadow-lg shadow-gray-950/20 dark:shadow-black -top-10 left-1/2 -translate-x-1/2 rounded-full py-2 px-5 bg-white text-sm text-gray-950">
                        Mobile
                      </motion.div>
                      <motion.div variants={variants2} className="text-2xl font-semibold dark:text-white text-gray-950">
                        Platform
                      </motion.div>
                      <motion.div
                        animate={{
                      ...
                      <motion.div variants={variants2} className="absolute text-center shadow-lg shadow-gray-950/20 dark:shadow-black bottom-20 -right-10 rounded-full py-2 px-5 bg-gray-600 text-sm text-white">
                        Dashboard
                      </motion.div>
                      <motion.div
                        animate={{
      ...
      <Popup state={showPopup} close={closePopup}>
        <div className="p-8">
          ...
          <div className="text-sm font-normal text-gray-700">팝업의 역할을 할 것입니다. 팝업의 기능은 언제든 이런 형태로 호출이 가능하게 할것이며 모달과는 다르게 아래에서 팝업이되며 바탕을 누른다고 없어지지 않습니다. 그리고 기간의 값을 입력하면 해당 기간 동안 팝업이 뜨지 않을 것입니다.</div>
        </div>
      </Popup>
      <Popup state={showPopup2} title="서비스 제안하기" close={closePopup2}>
        <div className="p-8">
          <div className="text-sm font-normal text-gray-700">
            <div className="flex justify-center items-center rounded-2xl bg-gray-100 p-8 text-sm text-gray-400">서비스 제안서 작성</div>
          </div>
        </div>
      </Popup>
    </MainLayout>
