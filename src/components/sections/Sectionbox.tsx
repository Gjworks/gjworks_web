    ...
    >
      <Link href="/metaverse">
        <div className="relative dark:bg-dark-700/25 rounded-xl p-5 flex-1 backdrop-blur-lg overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden bg-gradient-to-b from-slate-200/70 via-slate-200/25 to-white dark:from-dark-700/25 dark:via-dark-950/50 dark:to-dark-950"></div>
