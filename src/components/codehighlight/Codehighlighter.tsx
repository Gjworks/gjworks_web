...
const Codehighlighter = props => {
  ...
  return (
    <>
      <div className="Code bg-white dark:bg-dark-950/80 rounded-md overflow-hidden border border-gray-200 dark:border-dark-800 dark:border-t-dark-700 shadow-md shadow-gray-200/70 dark:shadow-dark-950 backdrop-blur-lg">
