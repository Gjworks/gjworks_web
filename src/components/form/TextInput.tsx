        ...
        <div className="relative flex">
          <input
            ...
            className={
              ...
              (props.theme === 'light'
                ? ' text-primary-500 border-primary-500 focus:border-primary-500 placeholder-shown:border-dark-500 placeholder-shown:text-slate-400 '
                : ' text-primary-500 border-primary-500 focus:border-primary-500 placeholder-shown:border-dark-500 placeholder-shown:text-slate-400 ')
            }
            placeholder=" "
          ...
          <div
            ...
            className={
              ...
              (props.theme === 'light'
                ? ' text-primary-500 peer-focus:text-primary-500 border-primary-500 peer-focus:border-primary-500 peer-placeholder-shown:text-slate-400 peer-placeholder-shown:border-slate-500 '
                : ' text-primary-500 peer-focus:text-primary-500 border-primary-500 peer-focus:border-primary-500 peer-placeholder-shown:text-dark-400 peer-placeholder-shown:border-dark-500 ')
            }
          >
            {props?.inputTitle}
          </div>
          <label
            ...
            className={
              ...
              (props.theme === 'light'
                ? ' bg-white text-primary-500 peer-placeholder-shown:text-slate-400 peer-focus:text-primary-500 '
                : ' dark:bg-dark-950 dark:text-primary-500 peer-placeholder-shown:text-dark-500 peer-focus:text-primary-500')
            }
          >
            {props?.placeholder}
          </label>
