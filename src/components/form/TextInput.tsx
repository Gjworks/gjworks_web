        ...
        <div className="relative flex">
          <input
            ...
            className={
              ...
              (props.theme === 'light'
                ? ' text-primary-500 border-primary-500 focus:border-primary-500 placeholder-shown:border-dark-600 placeholder-shown:text-slate-400 '
                : ' text-primary-500 border-primary-500 focus:border-primary-500 placeholder-shown:border-dark-600 placeholder-shown:text-slate-400 ')
            }
            placeholder=" "
          ...
          <div
            ...
            className={
              ...
              (props.theme === 'light'
                ...
                : ' text-primary-500 peer-focus:text-primary-500 border-primary-500 peer-focus:border-primary-500 peer-placeholder-shown:text-dark-500 peer-placeholder-shown:border-dark-600 ')
            }
          >
            {props?.inputTitle}
          </div>
