          ...
          <LeftPortal>
            ...
            >
              ...
              <motion.div
                ...
                className="fixed h-screen z-100 bg-white/50 dark:bg-dark-800/90 overflow-hidden overflow-y-auto text-slate-900 dark:text-white backdrop-blur-md dark:backdrop-blur-md shadow-xl shadow-slate-300 dark:shadow-slate-900"
              >
                {children}
              </motion.div>
            </motion.div>
