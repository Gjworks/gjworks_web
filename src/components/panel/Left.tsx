          ...
          <LeftPortal>
            ...
            >
              ...
              <motion.div
                ...
                className="fixed h-screen z-100 bg-gray-50 dark:bg-dark-900/50 shadow-md overflow-hidden overflow-y-auto text-gray-900 dark:text-white backdrop-blur dark:backdrop-blur-md"
              >
                {children}
              </motion.div>
            </motion.div>
