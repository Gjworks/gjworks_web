            ...
            <ModalPortal>
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative mt-20 mb-10 z-100 bg-white/80 dark:bg-dark-950/90 rounded-md max-w-screen-md shadow-md mx-auto overflow-hidden text-black dark:text-white"
                >
                  {children}
                </motion.div>
              </motion.div>
