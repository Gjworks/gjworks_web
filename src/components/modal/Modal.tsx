            ...
            <ModalPortal>
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative mt-20 mb-10 z-100 bg-white/90 dark:bg-dark-800/90 rounded-md max-w-screen-md shadow-md mx-auto overflow-hidden text-black dark:text-white dark:backdrop-blur-lg"
                >
                  {children}
                </motion.div>
              </motion.div>
