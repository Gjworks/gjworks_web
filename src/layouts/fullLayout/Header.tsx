      ...
      >
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-5 gap-4 px-3 py-1">
            <div className="relative col-span-3 flex justify-start">
              <button
                onClick={() => {
              ...
              <div className="relative flex items-center">
                <div className="col-span-1 relative flex justify-center items-center gap-1">
                  <div className="group relative flex items-center">
                    <Link
                      href="/"
                      className="flex items-center justify-center bg-dark-950 rounded-md p-0.5"
                    >
                      <Image
                        ...
                        width="32"
                        height="32"
                        className="block w-[1.6rem] h-[1.6rem] lg:w-[2.1rem] lg:h-[2.1rem]"
                      />
                      {/* <Image
                    ...
                    <div className="hidden group-hover:flex absolute top-0.5 lg:top-2 -right-10 z-10">
                      <div className="bg-pink-400 text-white py-1 px-2 rounded-md text-xs after:w-3 after:h-3 after:rounded-sm after:absolute after:-left-1 after:top-1.5 after:bg-pink-400 after:inline-block after:rotate-45 after:content-[''] after:z-50">
                        2.0
                      </div>
                    </div>
                    <a
                    ...
                    >
                      <div className="mr-4 flex pl-2 text-sm font-medium lg:text-sm">
                ...
                <div className="dark:before:bg-dark-700 group relative hidden items-center justify-center rounded-full px-4 py-1 lg:flex">
                          ...
                          <div className="flex gap-4 items-center">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-400 line-clamp-1">
                                Next.js, Prisma.js 등을 활용하여 간단한
                                웹서비스를 고급스럽게 제작하기 위한 웹 컴포넌트
                              </div>
                            </div>
                          </div>
                        </motion.div>
                  ...
                  <Link
                    href="/plextype"
                    className="hidden dark:text-dark-100 dark:bg-dark-100/10 cursor-pointer rounded-full bg-gray-100/90 px-4 py-1 text-xs text-gray-500 backdrop-blur-lg transition duration-300 hover:bg-gray-200/75 hover:text-black dark:hover:bg-gray-100/20 dark:hover:text-white"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
