  ...
  return (
    <>
      <motion.header
        ...
        className={
          'z-101 dark:bg-dark-950/75 sticky top-0 w-full bg-gray-100/90 pt-0 backdrop-blur-lg' +
          (showNavigation === true ? '  ' : ' ')
        }
      >
