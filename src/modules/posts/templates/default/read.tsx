      ...
      <div className="sticky top-0 bg-white/75 dark:bg-dark-950/75 backdrop-blur-lg z-99 pt-1 border-b border-gray-100 dark:border-dark-800">
        <div className="mx-auto  max-w-screen-md px-3">
          <div className="flex items-center gap-2">
            <div className="bg-sky-400 text-white dark:text-white text-xs px-4 py-1 rounded-full">
              기술공유
            </div>
              ...
              <div className="">
                <div className="pb-10">
                  ...
                  <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                    ...
                    (which can result in better SEO), and allows you to
                    customize how your content is presented on social media,
                    helping you create a more engaging and consistent user
                    experience across various platforms. The Metadata API in
                    Next.js allows you to modify the element of a page. You can
                    configure metadata in two ways: onfig-based Metadata: Export
                    a static metadata object or a dynamic generateMetadata
                    function in a layout.js or page.js file. File-based
                    Metadata: Add static or dynamically generated special files
                    to route segments. Additionally, you can create dynamic Open
                    Graph Images using JSX and CSS with imageResponse
                    constructor.
                  </div>
                  <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                    Next.js /public folder can be used to serve static assets
                    like images, fonts, and other files. Files inside /public
                    can also be cached by CDN providers so that they are
                ...
                <div className="py-10">
                  ...
                  <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                    ...
                    by managed and self-hosted Next.js. This ensures all
                    features are supported across both methods of deployment. In
                    the next major version, we will be transforming this output
                    into our Build Output API specification.
                  </div>
                  <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                    Vercel, the creators and maintainers of Next.js, provide
                    managed infrastructure and a developer experience platform
                    for your Next.js applications. Deploying to Vercel is
                    zero-configuration and provides additional enhancements for
                    scalability, availability, and performance globally.
                    However, all Next.js features are still supported when
                    self-hosted. Learn more about Next.js on Vercel or deploy a
                    template for free to try it out.
                  </div>
                </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="dark:text-dark-400 text-sm font-light text-gray-500">
                    ...
                    rendered output of the component is compared against the
