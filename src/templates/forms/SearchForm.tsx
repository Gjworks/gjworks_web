      ...
      <div className=" ">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex bg-gray-950 dark:text-primary-400 dark:bg-dark-700 py-1 px-3 text-xs rounded-full hover:bg-gray-700 dark:hover:bg-primary-500 dark:hover:text-black hover:text-black text-black cursor-pointer">
        ...
        >
          ...
          <div className="flex text-sm border-b border-slate-300/50 dark:border-dark-800 text-gray-600 dark:text-dark-500 py-3 hover:bg-gray-950 dark:hover:bg-primary-500 hover:text-white dark:hover:text-black px-3 rounded-sm cursor-pointer">
          ...
          <div className="flex text-sm text-gray-600 dark:text-dark-500 py-3 hover:bg-gray-950 dark:hover:bg-primary-500 hover:text-white dark:hover:text-black px-3 rounded-sm cursor-pointer">
