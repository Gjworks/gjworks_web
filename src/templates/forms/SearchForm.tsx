      ...
      <div className=" ">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex bg-primary-600 dark:text-white dark:bg-primary-700 py-1 px-3 text-xs rounded-full hover:bg-primary-500 dark:hover:bg-primary-600 dark:hover:text-white hover:text-white text-white cursor-pointer">
            ...
            <div className="flex bg-gray-300 dark:text-white dark:bg-primary-700 py-1 px-3 text-xs rounded-full hover:bg-primary-500 dark:hover:bg-primary-600 dark:hover:text-white hover:text-white text-gray-700 cursor-pointer">
        ...
        >
          ...
          <div className="flex text-sm border-b border-gray-300/50 dark:border-dark-700 text-gray-600 dark:text-dark-500 py-3 hover:bg-gray-300 dark:hover:bg-blue-700 hover:text-black dark:hover:text-white px-3 rounded-sm cursor-pointer">
          ...
          <div className="flex text-sm text-gray-600 dark:text-dark-500 py-3 hover:bg-gray-300 dark:hover:bg-blue-700 hover:text-black dark:hover:text-white px-3 rounded-sm cursor-pointer">
