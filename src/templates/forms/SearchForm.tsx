      ...
      <div className="px-3 bg-white/90 dark:bg-dark-900/90 backdrop-blur">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex bg-primary-400 dark:text-white dark:bg-primary-600 py-1 px-3 text-xs rounded-full hover:bg-primary-500 dark:hover:bg-primary-500 dark:hover:text-primary-100 hover:text-white text-white cursor-pointer shadow-lg shadow-primary-400/20">
        ...
        >
          ...
          <div className="flex text-sm border-b border-slate-300/50 dark:border-dark-700 text-gray-600 py-3 hover:bg-primary-500 dark:hover:bg-primary-600 hover:text-white dark:hover:text-white px-3 rounded-sm cursor-pointer">
          ...
          <div className="flex text-sm text-gray-600 py-3 hover:bg-primary-500 dark:hover:bg-primary-600 hover:text-white dark:hover:text-white px-3 rounded-sm cursor-pointer">
