  ...
  return (
    <>
      <motion.div className="w-56" variants={innerAnimation}>
        <Link
          href="/auth/Signin"
          className="hover:bg-primary-500 dark:hover:bg-dark-600/50 block rounded bg-transparent px-4 py-2 text-xs text-gray-800 hover:text-black dark:text-white dark:hover:text-white"
        >
