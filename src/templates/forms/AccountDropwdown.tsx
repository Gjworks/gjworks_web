...
const AccountDropwdown = () => {
  ...
  return (
    <>
      ...
      {/* <div className="block rounded px-4 py-2 text-xs hover:bg-black hover:text-white dark:hover:bg-dark-600/50 dark:text-white dark:hover:text-white backdrop-blur-lg"></div> */}
      {session.status === 'authenticated' ? (
        <>
          <motion.div variants={innerAnimation}>
            <Link
