  ...
  return (
    <>
      <div className="relative dark:shadow-dark-950 block rounded-t-lg bg-[url('/assets/images/bg23.jpg')] bg-cover bg-center">
        ...
        <div className="relative mx-auto  max-w-screen-lg px-3 py-20">
          <div className="text-5xl font-light text-white py-4 text-center pt-20">
      ...
      <div className="sticky top-0 bg-white/75 backdrop-blur-lg z-99 pt-1 border-b border-gray-100">
        <div className="mx-auto  max-w-screen-md px-3">
          <div className="flex items-center gap-2">
            <div className="bg-primary-600 text-white text-sm px-5 py-1 rounded-full">
              기술공유
            </div>
            <div className="text-xl font-light text-gray-950 py-4">
      ...
      <div className="mx-auto max-w-[2560px]">
        <div className="mx-auto  max-w-screen-md px-3">
          <div className="flex items-center justify-between gap-8 pt-5 pb-3">
            ...
            <div className="">
              <div className="pb-10">
                <div className="dark:border-dark-800/75 dark:bg-dark-700/40 mb-8 hidden rounded-lg border border-gray-200/50 bg-white/90 p-5 shadow-md shadow-gray-100/75 dark:shadow-black/90">
                  <div className="grid grid-cols-4 gap-10">
                    <div className="col-span-1">
                      <div className="text-primary-700 mb-3 text-base">
                        1,200
                      </div>
                ...
                <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                  Metadata helps search engines understand your content better
                  (which can result in better SEO), and allows you to customize
                  how your content is presented on social media, helping you
                  create a more engaging and consistent user experience across
                  various platforms. The Metadata API in Next.js allows you to
                  modify the element of a page. You can configure metadata in
                  two ways: onfig-based Metadata: Export a static metadata
                  object or a dynamic generateMetadata function in a layout.js
                  or page.js file. File-based Metadata: Add static or
                  dynamically generated special files to route segments.
                  Additionally, you can create dynamic Open Graph Images using
                  JSX and CSS with imageResponse constructor.
                </div>
                <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                  Next.js /public folder can be used to serve static assets like
                  images, fonts, and other files. Files inside /public can also
                  be cached by CDN providers so that they are delivered
                  efficiently.
                </div>
              </div>
              ...
              <div className="py-10">
                ...
                <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                  Running next build generates an optimized version of your
                  application for production. HTML, CSS, and JavaScript files
                  are created based on your pages. JavaScript is compiled and
                  browser bundles are minified using the Next.js Compiler to
                  help achieve the best performance and support all modern
                  browsers. Next.js produces a standard deployment output used
                  by managed and self-hosted Next.js. This ensures all features
                  are supported across both methods of deployment. In the next
                  major version, we will be transforming this output into our
                  Build Output API specification.
                </div>
                <div className="dark:text-dark-300 mb-5 text-base font-light text-gray-700">
                  Vercel, the creators and maintainers of Next.js, provide
                  managed infrastructure and a developer experience platform for
                  your Next.js applications. Deploying to Vercel is
                  zero-configuration and provides additional enhancements for
                  scalability, availability, and performance globally. However,
                  all Next.js features are still supported when self-hosted.
                  Learn more about Next.js on Vercel or deploy a template for
                  free to try it out.
                </div>
              </div>
