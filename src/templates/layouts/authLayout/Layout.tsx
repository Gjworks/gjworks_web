...
const Layout = ({ children }) => {
  ...
  return (
    <motion.div className="selection:text-black selection:bg-primary-300 break-keep dark:bg-transparent min-h-full">
      ...
      <div className="relative z-20">
        <motion.header
          ...
          className="sticky top-0 backdrop-blur-lg before:backdrop-blur-lg bg-white/70 dark:bg-dark-950/60 z-101 "
        >
