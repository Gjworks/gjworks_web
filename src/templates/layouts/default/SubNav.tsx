...
const SubNav = () => {
  ...
  return (
    <>
      ...
      <div className="sticky backdrop-blur-lg bg-white/80 top-0 z-[50] border-b border-slate-100 dark:bg-dark-900/80 dark:border-dark-800">
        <div className="max-w-screen-lg mx-auto px-3">
          <div className="flex justify-between">
            <Link href="/" className="font-semibold text-xl py-3">
              Discovery
            </Link>
