...
const SubNav = () => {
  ...
  return (
    <>
      {snav && (
        <div className="sticky top-[60px] z-[50] bg-white/80 backdrop-blur-lg dark:backdrop-blur-lg border-b border-slate-100 dark:bg-dark-950/90 dark:border-dark-950">
      ...
      <div className="sticky backdrop-blur-lg bg-white/80 top-0 z-[50] dark:bg-dark-950/90 pb-2">
