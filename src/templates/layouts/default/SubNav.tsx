...
const SubNav = () => {
  ...
  return (
    <>
      <div className="sticky backdrop-blur-lg bg-white/90 top-0 z-[50] dark:bg-dark-900/60 border-b border-gray-100 dark:border-dark-800 dark:shadow-lg shadow-slate-200/40 dark:shadow-slate-950/20">
