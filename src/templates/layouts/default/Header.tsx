  ...
  return (
    <>
      <motion.header
        ...
        className="sticky top-0 backdrop-blur-lg before:backdrop-blur-lg bg-slate-50/90 dark:bg-dark-950/60 z-101"
      >
      ...
      >
        <motion.div
          ...
          className="bg-slate-50/90 backdrop-blur-lg before:backdrop-blur-lg dark:backdrop-blur-lg dark:bg-dark-950/60 z-100"
        >
          <motion.div
            initial={initial}
            variants={variants}
