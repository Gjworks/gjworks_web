...
const MainLayout = ({children}) => {
  ...
  return (
    <div className="selection:text-black selection:bg-yellow-400 dark:selection:bg-blue-500 dark:selection:text-white break-keep">
      ...
      <div className="fixed lg:hidden bottom-0 left-0 right-0 bg-gray-50/90 backdrop-blur-lg border-t border-gray-200/75 z-999 pb-2">
          ...
          <div className="col-span-1">
            ...
            >
              <div className="">
                ...
                <div className="text-[11px] text-center">Home</div>
              </div>
            </Link>
          </div>
          <div className="col-span-1">
            ...
            >
              <div className="">
                ...
                <div className="text-[11px] text-center">Store</div>
              </div>
            </Link>
          </div>
          <div className="col-span-1">
            ...
            >
              <div className="">
                ...
                <div className="text-[11px] text-center">Works</div>
              </div>
            </Link>
          </div>
          <div className="col-span-1">
            ...
            >
              <div className="">
                ...
                <div className="text-[11px] text-center">Cart</div>
              </div>
            </Link>
          </div>
          <div className="col-span-1">
            ...
            >
              <div className="">
                ...
                <div className="text-[11px] text-center">나</div>
              </div>
            </Link>
          </div>
        </div>
