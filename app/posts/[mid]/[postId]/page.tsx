      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <div className="col-span-12 lg:col-span-12 xl:col-span-10">
              ...
              <motion.div className="flex flex-col gap-3 pt-6 md:flex-row md:gap-0 lg:gap-3" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:0.7}}}>
                <div className="mr-4 w-max">
                  <div className="flex items-center gap-3">
                    <div className="w-10">
                      <div className="w-10 h-10 rounded-full bg-dark-500"></div>
                    </div>
                    <div className="">
                      <div className="text-scale-1200 mb-0 text-sm text-white">
                        Jon Meyers
                      </div>
                      <div className="text-scale-900 mb-0 text-xs text-dark-300">
                        Developer Advocate
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-12 lg:gap-16 xl:gap-8">
            <motion.div className="col-span-12 lg:col-span-7 xl:col-span-7 text-dark-200 text-base leading-7" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:0.8}}}>
            ...
            <motion.div className="col-span-12 space-y-8 lg:col-span-5 xl:col-span-3 xl:col-start-9 text-dark-100 text-sm" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:.95}}}>
              <div className="space-y-8 lg:sticky lg:top-20 lg:mb-16">
                ...
                <div className="">
                  ...
                  <div>
                    <Link href="" className="block w-full mb-2 text-dark-300 hover:text-white text-sm">
                      This article
                    </Link>
                    <Link href="" className="block w-full mb-2 text-dark-300 hover:text-white text-sm">
                      Components example
