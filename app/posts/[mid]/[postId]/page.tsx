      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12 mb-2 lg:col-span-2 text-sm">
          <div className="lg:sticky lg:top-20 lg:mb-16 flex justify-between lg:block">
            <div className="mb-10">
              <Link href="/" className="flex items-center gap-2 text-dark-300 hover:text-white">
        ...
        <div className="col-span-12 lg:col-span-12 xl:col-span-10">
          <motion.div className="mb-16 max-w-5xl space-y-8" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:0.5}}}>
            <div className="space-y-4">
              ...
              <motion.div className="text-scale-500 flex space-x-2 text-sm text-dark-400 font-normal" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:0.6}}}>
                <div></div>
                <div>카테고리</div>
                <div>Topic 34</div>
              </motion.div>
              <motion.div className="flex flex-col gap-3 pt-6 md:flex-row md:gap-0 lg:gap-3" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:0.7}}}>
          ...
          <div className="grid grid-cols-12 lg:gap-16 xl:gap-8">
            <div className="col-span-12">
              <div className=" flex items-center justify-center max-w-screen-lg w-full h-[480px] rounded-lg shadow-lg shadow-dark-900 bg-dark-900 mb-8 text-3xl font-extrabold text-dark-400/25">
                <div>
            ...
            <motion.div className="col-span-12 lg:col-span-7 xl:col-span-7 text-dark-300 text-base leading-7" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:0.8}}}>
              <Suspense fallback={<Loading />}>
                <Description desc={documentInfo?.data.description}></Description>
              </Suspense>
              <div className="pt-8 pb-16 border-t border-dark-500">
              </div>
            </motion.div>
            <motion.div className="col-span-12 space-y-8 lg:col-span-5 xl:col-span-3 xl:col-start-9 text-dark-100 text-sm" initial={{opacity:0, y:"20%"}} animate={{opacity:1, y:0, transition: {duration:.95}}}>
              <div className="space-y-8 lg:sticky lg:top-20 lg:mb-16">
                ...
                <div className="">
                  ...
                  <div>
                    <Link href="" className="block w-full mb-2 text-dark-400 hover:text-white text-sm">
                      This article
                    </Link>
                    <Link href="" className="block w-full mb-2 text-dark-400 hover:text-white text-sm">
                      Components example
