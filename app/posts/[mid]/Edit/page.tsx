      ...
      <div className="max-w-screen-2xl mx-auto px-3 py-20">
        <div className="flex gap-8 flex-wrap">
          ...
          <div className="flex w-full lg:flex-1">
            <label className="hidden w-24 text-dark-300 text-sm px-3 py-3">
              제목
            </label>
            <div className="flex-1">
              <input
                ...
                className="bg-dark-900 text-sm text-dark-300 focus:text-white py-2 px-3 mb-3 focus:outline-none w-full border-b border-dark-500 focus:border-primary-500 placeholder-dark-300"
                onChange={onChange}
                required
              />
            </div>
        ...
        <div className="grid grid-cols-2 gap-8 pt-6">
          <div className="col-span-2 flex gap-4 flex-wrap">
            <div className="flex w-full lg:w-auto">
              <label className="hidden w-24 text-dark-300 text-xs px-3 py-3">
                Name
              </label>
              <div className="flex-1">
                <input
                  ...
                  className="w-full lg:w-96 bg-dark-900 text-sm text-dark-300 focus:text-white py-2 px-3 lg:mb-0 focus:outline-none border-b border-dark-500 focus:border-primary-600 placeholder-gray-600"
                  required
                />
              </div>
            </div>
