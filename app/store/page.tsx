    ...
    <>
      <div className="max-w-screen-xl mx-auto px-3 py-20">
        <div className="grid grid-cols-3 gap-8">
            ...
            <div className="group relative rounded-lg bg-dark-900 overflow-hidden shadow-lg shadow-slate-400 dark:shadow-dark-950 bg-[url('/assets/images/bg9.jpg')] bg-no-repeat bg-cover bg-center ">
              ...
              <div className="relative h-[200px] overflow-hidden">
                <div className="group relative h-[200px]">
                  ...
                  <div className="relative w-full h-full bg-primary-500 bg-[url('/assets/images/bg9.jpg')] bg-no-repeat bg-cover bg-center transition duration-700 group-hover:scale-[1.08]"></div>
              ...
              <div className="relative flex items-center p-3 gap-4">
                ...
                <div className="flex items-center bg-dark-700 text-sky-400 text-sm py-1 px-5 rounded-full">
                  120,000
                </div>
              </div>
            </div>
          ...
          <div className="col-span-3 md:col-span-1">
            <div className="group relative rounded-lg bg-dark-900 overflow-hidden shadow-lg shadow-slate-400 dark:shadow-dark-950 bg-[url('/assets/images/primary/primary_bg3.jpg')] bg-no-repeat bg-cover bg-center ">
              <div className="absolute inset-0 backdrop-blur-lg bg-dark-900/60"></div>
              <div className="relative h-[200px] overflow-hidden">
                <div className="group relative h-[200px]">
                  {/* <div className="absolute inset-0 bg-gradient-to-b from-transparent via-dark-950/40 to-dark-950"></div> */}
                  <div className="relative w-full h-full bg-primary-500 bg-[url('/assets/images/primary/primary_bg3.jpg')] bg-no-repeat bg-cover bg-center transition duration-700 group-hover:scale-[1.08]"></div>
                  <div className="absolute bottom-3 left-3">
                    <div className="relative text-white bg-white/10 py-1 px-3 backdrop-blur-lg rounded-lg text-xs">
                      Next.js
                    </div>
