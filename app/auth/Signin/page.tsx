      ...
      <div className="max-w-lg mx-auto p-5">
        <form onSubmit={submitHandler}>
          <div className="py-10 text-center">
            <div className="text-lg text-dark-50">Sign in</div>
          </div>
          {formMessage &&
            <div className="py-5">
          ...
          <div className="flex px-3 mb-5 w-full">
            ...
            <input type="text" ref={emailInputRef} name="email" id="email" className="bg-dark-900 text-sm text-dark-300 focus:text-white py-3 px-3 focus:outline-none w-full border-b border-dark-500 focus:border-primary-500 placeholder-gray-600" placeholder="What's your Email" />
          </div>
          <div className="flex px-3 mb-5 w-full">
            <label className="flex items-center w-24 text-dark-300 text-xs">Password</label>
            <input type="password" ref={passwordInputRef} name="password" id="password" className="bg-dark-900 text-sm text-dark-300 focus:text-white py-3 px-3 focus:outline-none w-full border-b border-dark-500 focus:border-primary-500 placeholder-gray-600" placeholder="Password" />
          </div>
        ...
        <div className="py-5">
          <div className="flex gap-4">
            ...
            <button onClick={() => signIn('github')} className="flex-1 flex justify-center bg-dark-700 hover:bg-dark-600 rounded-md px-3 py-3 mb-2 cursor-pointer">
              <div className="pr-3">
