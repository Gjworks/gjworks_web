        ...
        <div className="max-w-lg mx-auto p-5">
          <form onSubmit={submitHandler}>
            ...
            <div className="flex mb-4">
              <button
                type="submit"
                className="flex justify-center items-center w-full bg-primary-400 dark:bg-primary-400 dark:hover:bg-primary-500 hover:text-black dark:hover:text-black dark:text-black text-black py-4 px-5 rounded-lg transition duration-300 hover:bg-primary-500"
              >
                <svg
          ...
          <div className="pb-10">
            <div className="flex flex-wrap">
              <div className="w-full">
                ...
                >
                  회원가입을 하시려면{' '}
                  <span className="group-hover:text-primary-400 text-primary-500 hover:text-primary-400 underline">
                    회원가입 하기
                  </span>
                </Link>
              </div>
