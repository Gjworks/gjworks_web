      ...
      <div className="max-w-lg mx-auto p-5">
        <form onSubmit={submitHandler}>
          <div className="py-10 text-center">
            <div className="text-lg text-gray-500 dark:text-dark-50">Sign in</div>
          </div>
          {formMessage &&
            <div className="py-5">
        ...
        <div className="py-5">
          <div className="flex gap-4">
            ...
            <button onClick={() => signIn('github')} className="flex-1 flex justify-center bg-gray-100 dark:bg-dark-700 hover:bg-gray-200 dark:hover:bg-dark-600 rounded-md px-3 py-3 mb-2 cursor-pointer">
              <div className="pr-3">
