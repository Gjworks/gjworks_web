      ...
      <div className="max-w-lg mx-auto p-5">
        <form onSubmit={submitHandler}>
          <div className="py-10 text-center">
            <div className="text-lg text-dark-500 dark:text-dark-50">Sign in</div>
          </div>
          {formMessage &&
            <div className="py-5">
          ...
          <div className="flex px-3 mb-5 w-full">
            ...
            <input type="text" ref={emailInputRef} name="email" id="email" className="bg-dark-50 dark:bg-dark-900 text-sm text-dark-500 dark:text-dark-300 focus:text-white py-3 px-3 focus:outline-none w-full border-b border-dark-400 dark:border-dark-500 focus:border-primary-500 placeholder-dark-400 dark:placeholder-dark-600" placeholder="What's your Email" />
          </div>
          <div className="flex px-3 mb-5 w-full">
            <label className="flex items-center w-24 text-dark-300 text-xs">Password</label>
            <input type="password" ref={passwordInputRef} name="password" id="password" className="bg-dark-50 dark:bg-dark-900 text-sm text-dark-500 dark:text-dark-300 focus:text-white py-3 px-3 focus:outline-none w-full border-b border-dark-400 dark:border-dark-500 focus:border-primary-500 placeholder-dark-400 dark:placeholder-dark-600" placeholder="Password" />
          </div>
        ...
        <div className="divider">
          <div className="relative py-4">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-b border-dark-300 dark:border-dark-700"></div>
            </div>
        ...
        <div className="py-5">
          <div className="flex gap-4">
            ...
            <button onClick={() => signIn('github')} className="flex-1 flex justify-center bg-dark-100 dark:bg-dark-700 hover:bg-dark-200 dark:hover:bg-dark-600 rounded-md px-3 py-3 mb-2 cursor-pointer">
              <div className="pr-3">
        ...
        <div className="pb-10">
          <div className="flex flex-wrap">
            <div className="w-full">
              <Link href="/auth/Register" className="group text-sm text-dark-300">
                회원가입을 하시려면 <span className="group-hover:text-primary-400 text-primary-500 underline">회원가입 하기</span>
              </Link>
            </div>
            <div className="w-full">
              <Link href="/" className="group text-sm text-dark-400">
                이메일과 비밀번호를 잊어버리 셨나요? <span className="group-hover:text-primary-300 text-primary-500 underline">Email/비밀번호 찾기</span>
              </Link>
            </div>
          </div>
        </div>
