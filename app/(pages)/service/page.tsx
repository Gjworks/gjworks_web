        ...
        <div className="py-10">
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2 p-3">
              <div className="relative overflow-hidden bg-slate-100/80 border border-white dark:border-dark-800/20 dark:bg-dark-900/70 backdrop-blur-xl shadow-sm hover:shadow-lg shadow-gray-100 hover:shadow-slate-200 dark:shadow-dark-950 p-8 lg:p-16 rounded-2xl w-full hover:shadow-xs">
