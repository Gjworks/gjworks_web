          ...
          <div className="py-20">
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="col-span-2 lg:col-span-1 order-0 lg:order-1">
                <div className="relative overflow-hidden bg-white/90 border border-white dark:border-dark-800/20 dark:bg-dark-950/40 backdrop-blur-lg p-8 lg:p-16 rounded-2xl w-full">
