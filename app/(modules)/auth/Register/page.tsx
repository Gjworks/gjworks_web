        ...
        <div className="max-w-xl mx-auto p-5">
          ...
          <form onSubmit={submitHandler}>
            ...
            <div className="flex mb-2">
              <button className="flex justify-center items-center w-full bg-slate-900 dark:bg-primary-600 dark:hover:bg-primary-700 hover:text-white dark:hover:text-white dark:text-white text-white py-4 px-5 rounded-lg transition duration-300 hover:bg-slate-700">
                Register Completed
              </button>
            </div>
          </form>
