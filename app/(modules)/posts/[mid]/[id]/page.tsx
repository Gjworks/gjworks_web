...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="dark:bg-dark-950/70 sticky top-0 z-50 w-full">
        <div className="mx-auto flex max-w-screen-lg items-center justify-between gap-8 px-3 py-3">
              ...
              <div className="mx-auto max-w-screen-md">
                <div className="flex flex-wrap gap-4 lg:gap-16">
                  <div className="w-32">
                    ...
                    <div className="text-gray-400">React, Next.js, Prisma</div>
                  </div>
                  <div className="w-full md:flex-1">
                    <div className="block overflow-hidden pb-8 text-2xl font-medium text-white md:pb-16 lg:text-4xl">
                      <div className="line-clamp-2 ">
                        ...
                        show them right below the hero, ideally above the fold.
                      </div>
                    </div>
                    <div className="block overflow-hidden pb-8 text-base leading-snug text-gray-300 md:pb-16">
                      <div className="line-clamp-3 ">
                        I recently spent a bit of time debating image, copy, CTA
                        for an eCommerce homepage redesign project. I tried to
                        use another similar website to show what I'd suggest. So
                        I designed a suggestion I'd make to improve the
                        fenix-store.com homepage hero. It's heavily inspired by
                        DJI/apple/B&H while still featuring the core elements of
                        Fenix. I cut down and rearranged a bunch of stuff to
                        make the UI more aligned with what I deem to be more
                        modern standards.
                      </div>
                    </div>
                  </div>
