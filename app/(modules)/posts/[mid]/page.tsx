...
const Page: React.FC<PageProps> = ({params}) => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-12 px-3 pb-20 pt-12 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-7">
          ...
          <Link href="/posts/works/1" className="group">
            ...
            <div className="px-1">
              <div className="mb-6 w-full">
                <div className="dark:text-dark-100 mb-3 line-clamp-2 text-2xl font-light text-gray-800 group-hover:text-secondary-500">
