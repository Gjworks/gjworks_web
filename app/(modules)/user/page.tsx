          ...
          <div className="max-w-screen-md mx-auto">
              ...
              <div className="elative w-full overflow-hidden rounded-xl border border-gray-200/75 bg-gray-100 p-5 shadow-lg shadow-gray-100/90 backdrop-blur-xl lg:p-10 h-full mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="col-span-1">
                    <div className="rounded-2xl p-5 bg-white shadow-sm hover:shadow-md shadow-gray-200/70">
            ...
            <div className="col-span-7">
              <div className="rounded-2xl p-8  mb-6">
                <div className="mb-8 font-semibold text-lg">일일 사용량</div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="col-span-1 rounded-2xl p-8 bg-purple-100 mb-6">
                  <div className="mb-8 font-semibold text-lg">활동 기록</div>
                </div>
                <div className="col-span-1 rounded-2xl p-8 bg-sky-100 mb-6">
