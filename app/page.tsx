        ...
        <div className="bg-dark-50 dark:bg-dark-800 bg-opacity-75 py-20">
          <div className="max-w-screen-2xl mx-auto px-3 xl:px-8">
            <div className="flex gap-8 w-full">
              <motion.div initial="offscreen" whileInView="onscreen" viewport={{ once: false, amount: 0.3 }} variants={parentVariants}  className=" w-full xl:w-3/5">
              ...
              <motion.div className=" flex gap-10 justify-center items-center w-full xl:w-2/5">
              <div className="flex justify-center w-20 h-20 stroke-dark-500 fill-dark-500">
