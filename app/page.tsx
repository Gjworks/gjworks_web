  ...
  return (
    <DefaultLayout>
      ...
      <div className="relative py-2 px-3">
        <motion.div className="relative mx-auto pt-20 xl:py-20">
          {/* <div className="absolute inset-0 overflow-hidden bg-dark-950/50"></div> */}
          <motion.div
            initial="offscreen"
            whileInView="onscreen"
            viewport={{ once: false, amount: 0.3 }}
            className="flex relative max-w-screen-lg mx-auto px-3 py-20 z-10"
          >
      ...
      <div className="py-20">
        <div className="relative max-w-screen-xl mx-auto px-3">
          ...
          >
            <motion.div
              variants={variants}
              className=" bg-gradient-to-b from-dark-800 via-dark-900/30 to-dark-900/60 p-10 rounded-xl w-full lg:flex-1 transition duration-300 hover:shadow-xs -translate-y-4 hover:translate-y-0 "
            >
              ...
              <div className="text-sm text-dark-300 mb-10">
                라이믹스 모듈제작과 데이터 이전 그리고 유지보수까지 모든 부분의
                제작을 의뢰를 통해 하고 있습니다. 결제 모듈과 카카오톡 메세지
                전송까지 다양한 서드파티 모듈을 가지고 있으며 라이믹스의 모든
                부분에 해당 기능을 추가하여 코어 수정 없이 지원합니다.
              </div>
            </motion.div>
            <motion.div
              variants={variants}
              className="relative overflow-hidden bg-gradient-to-b from-dark-700 via-dark-800 to-dark-900 p-10 rounded-xl w-full lg:flex-1 transition duration-300 hover:shadow-xs -translate-y-4 hover:translate-y-0 "
            >
              ...
              <div className="text-sm text-slate-400 dark:text-dark-100 mb-10">
                ...
                프론트엔드에서 뛰어난 퍼포먼스와 일관성 있는 UI/UX를 제작합니다.
              </div>
                ...
                <div>
                  <div className="w-[240px]">
                    ...
                    <div className="relative bg-dark-500 rounded-lg p-2 text-white text-sm font-normal mb-1 shadow-md shadow-dark-900 overflow-hidden">
                      <div className="absolute bg-rose-600 -left-6 bottom-0 rounded-full w-20 h-20"></div>
                      <div className="ml-16 text-rose-500">Data Fetching</div>
                    </div>
                    <div className="relative bg-dark-700 rounded-lg p-2 text-dark-200 text-sm font-normal mb-1 shadow-md shadow-dark-900 overflow-hidden">
                      <div className="absolute bg-dark-600 -left-6 bottom-0 rounded-full w-20 h-20"></div>
      ...
      <div className="py-20">
        <div className="relative max-w-screen-xl mx-auto px-3">
          ...
          >
            <motion.div
              variants={variants}
              className="bg-gradient-to-b from-dark-600 via-dark-700 to-dark-800 p-10 rounded-xl w-full lg:flex-1 transition duration-300 hover:shadow-xs -translate-y-4 hover:translate-y-0 "
            >
            ...
            <motion.div
              variants={variants}
              className=" bg-gradient-to-b from-dark-700 via-dark-800 to-dark-900 p-10 rounded-xl w-full lg:flex-1 transition duration-300 hover:shadow-xs -translate-y-4 hover:translate-y-0 "
            >
              <div className="text-3xl text-black dark:text-white font-bold mb-8">
                Partners
              </div>
