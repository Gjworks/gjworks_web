  ...
  return (
    <div className="selection:text-white selection:bg-orange-500">
      <div className="h-full">
        <div className="fixed w-full top-0 bg-dark-900/90 backdrop-blur-lg h-[60px] z-101">
          <div className="flex">
            ...
            <div className="flex items-center px-3">
              <div className="max-w-xl flex items-center rounded-full bg-gray-900/75 px-3 text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="flex items-center py-3 bg-gray-900/25 backdrop-blur-lg px-3">
        ...
        <div className="bg-white border-b border-dark-200 dark:border-dark-700 mt-[60px]"></div>
        <div className="fixed w-[300px] bg-white dark:bg-dark-900 backdrop-blur-lg h-screen overflow-hidden overflow-y-auto border-r border-slate-200 dark:border-gray-800">
          <DashboardSideNav />
        </div>
        <div className="relative top-0 ml-[300px] bg-white dark:bg-dark-900">
