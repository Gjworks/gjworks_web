          ...
          <div className="relative">
            <div className="relative mx-auto max-w-screen-md w-full p-10 bg-dark-900">
              ...
              <div className="flex justify-center gap-4 pt-5">
                <Link
                  href="/"
                  className="flex gap-4 px-5 py-3 bg-dark-700 hover:bg-dark-500 rounded-md text-sm text-dark-100"
                >
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <Link
                  href="/auth/Signin"
                  className="flex gap-4 px-10 py-3 bg-rose-500 hover:bg-rose-600 rounded-md text-sm text-dark-100 hover"
                >
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="p-5">
              ...
              <div className="rounded-lg bg-dark-800 overflow-hidden mb-2">
                ...
                <div className="py-3 px-3">
                  <div className="text-sm text-dark-300 font-bold mb-1">
                    이것은 알림을 보내기 위함
                  </div>
                  <div className="text-sm text-dark-400 font-normal">
                    Hi, Can't wait to see you tonight!
                  </div>
                </div>
              </div>
              <div className="rounded-lg bg-dark-800 overflow-hidden mb-2">
