  ...
  return (
    <>
      <div className="relative">
        ...
        <div className="sticky top-[60px] border-b dark:border-dark-700 bg-white/25 dark:bg-dark-900/25 backdrop-blur-lg">
          <div className="flex">
            <Link
              href="#"
              className="text-sm py-3 px-5 cursor-pointer border-b border-orange-500 text-black dark:text-white -mb-[1px]"
            >
              기본정보
            </Link>
            <Link
                      ...
                      <div className="col-span-2 grid grid-cols-3 gap-6">
                        <div className="col-span-3 sm:col-span-2">
                          ...
                          <input
                            ...
                            className={
                              'bg-gradient-to-r text-slate-900 dark:text-white outline-none py-2 px-4 text-sm border-b border-slate-300 dark:border-dark-700 w-full bg-slate-300/25 dark:bg-dark-800/25 rounded-tl rounded-tr focus:border-orange-500 focus:from-orange-500/25' +
                              (emailExist
