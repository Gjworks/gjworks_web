                      ...
                      <div className="col-span-2 grid grid-cols-3 gap-6">
                        <div className="col-span-3 sm:col-span-2">
                          ...
                          <input
                            ...
                            className={
                              'bg-gradient-to-r text-white outline-none py-2 px-4 text-sm border-b border-dark-700 w-full bg-dark-800/25 rounded-tl rounded-tr focus:border-orange-500 focus:from-orange-500/25' +
                              (emailExist
                      ...
                      <div className="col-span-2 grid grid-cols-3 gap-6">
                        <div className="col-span-3 sm:col-span-2">
                          ...
                          <input
                            ...
                            className="bg-gradient-to-r text-white outline-none py-2 px-4 text-sm border-b border-dark-700 w-full bg-dark-800/25 focus:border-orange-500 focus:from-orange-500/25 rounded-tl rounded-tr"
                    ...
                    <div className="grid grid-col-span-2 gap-8">
                      <div className="col-span-2 grid grid-cols-3 gap-6">
                        <div className="col-span-3 sm:col-span-2">
                          ...
                          <label className="m-0">
                            ...
                            />
                            <div className="block relative rounded-full cursor-pointer bg-dark-600 w-12 h-6 after:content-[''] after:absolute top-[1px] after:rounded-full after:h-6 after:w-6 after:shadow-md after:bg-dark-500 dark:after:bg-dark-100 after:transition-all peer-checked:bg-orange-500 after:peer-checked:translate-x-6 "></div>
                          </label>
                      ...
                      <div className="col-span-2 grid grid-cols-3 gap-6">
                        <div className="col-span-3 sm:col-span-2">
                          ...
                          <textarea className="bg-gradient-to-r text-white outline-none py-2 px-4 text-sm border-b border-dark-700 w-full bg-dark-800/25 focus:border-orange-500 focus:from-orange-500/25 rounded-tl rounded-tr"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
