    ...
    {state &&
      <LeftPortal>
        <motion.div initial={{marginRight: "100%"}} animate={panelState===true ? "openPanel" : "closePanel"} variants={variants} exit={exit} className="fixed inset-0 transform overflow-auto bg-transition z-90">
          ...
          <motion.div initial={{width:"320px",marginLeft:"-320px"}} animate={{width:"320px", marginLeft:0, transition:{duration:0.3}}} exit={{width:"320px",marginLeft:"-320px", transition:{duration:0.3}}} className="fixed h-screen z-100 bg-gray-50 dark:bg-dark-900/50 shadow-md overflow-hidden overflow-y-auto text-gray-900 dark:text-white backdrop-blur dark:backdrop-blur-md">
            {children}
          </motion.div>
        </motion.div>
      </LeftPortal>  
