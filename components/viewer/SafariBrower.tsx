const SafariBrower = () => {
  return(
    <>
      <div className="shadow-xl shadow-dark-800 sm:rounded-xl min-w-full max-w-full demo-sm:min-w-0 demo-sm:max-w-none mb-10">
        <div className="sm:rounded-xl ring-1 ring-dark-900/5">
          <div className="sm:rounded-t-xl bg-gradient-to-b from-dark-500 to-dark-600 highlight-dark/10">
            <div className="py-2.5 flex px-4 gap-6">
              ...
              <div className="flex-1">
                <div className="rounded-md font-medium text-xs leading-6 py-1 flex items-center justify-center ring-1 ring-inset ring-dark-800/5 mx-auto w-4/5 bg-dark-700 text-dark-300">
