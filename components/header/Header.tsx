...
const Header = () => {
  ...
  return(
      <>
      <div className="hidden relative bg-transparent bg-primary-700 shadow-black z-20">
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="flex items-center">
              ...
              <Link href={process.env.NEXT_PUBLIC_DEFAULT_URL} className="hidden lg:flex items-center">
                ...
                <div className="flex text-dark-100 text-xs lg:text-xs bg-dark-400 bg-opacity-75 px-4 py-1 rounded-full hover:bg-dark-700 hover:text-white transition duration-300">
            ...
            <div className="flex items-center pl-3">
              <Link href="/Works" className={"block py-0 lg:py-2 px-1 lg:px-3 mx-2 text-xs lg:text-sm font-normal " + (pathname === "/Works" ? "text-white" : "text-dark-200 hover:text-white")}>
                Works
              </Link>
              <Link href="/posts/[mid]" as="/posts/blog" className={"block py-0 lg:py-2 px-1 lg:px-3 mx-2 text-xs lg:text-sm font-normal " + (pathname  === "/posts/blog" ? "text-white" : "text-dark-200 hover:text-white")}>
                Blog
              </Link>
              <Link href="/Contact" className={"block py-0 lg:py-2 px-1 lg:px-3 mx-2 text-xs lg:text-sm font-normal " + (pathname === "/Contact" ? "text-white" : "text-dark-200 hover:text-white")}>
                Contact
              </Link>
            </div>
          </div>
