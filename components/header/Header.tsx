          ...
          <div className="flex items-center justify-center">
            ...
            <div className="flex items-center">
              ...
              <Link href={process.env.NEXT_PUBLIC_DEFAULT_URL} className="hidden lg:flex items-center">
                ...
                <div className="flex text-gray-500 dark:text-dark-100 text-xs lg:text-xs bg-gray-200 dark:bg-dark-400 bg-opacity-75 px-4 py-1 rounded-full hover:bg-gray-300 dark:hover:bg-dark-500 hover:text-black dark:hover:text-white transition duration-300">
