      ...
      <div className="max-w-md mx-auto p-5">
        <form onSubmit={submitHandler}>
          ...
          <div className="flex px-3 mb-2 w-full">
            ...
            <input type="text" ref={emailInputRef} name="email" id="email" className="bg-dark-900 text-sm text-dark-300 focus:text-white py-2 px-3 focus:outline-none w-full border-b border-dark-500 focus:border-primary-500 placeholder-gray-600" placeholder="What's your Email" />
          </div>
