  ...
  if (router.query.status == 'success') {
    return (
      ...
      <div className="px-3 py-10 lg:py-20">
        <div className="max-w-screen-sm mx-auto p-3 lg:p-8 rounded-lg bg-dark-700">
          <div className="flex justify-center mb-4 pt-5 text-lime-400">
            <span className="flex bg-lime-200 bg-opacity-25 rounded-full">
          ...
          <div className="flex overflow-hidden rounded-md">
            <Link href="/">
              <a className="flex items-center bg-dark-500 text-sm text-white py-3 px-5 lg:px-10 hover:bg-dark-400">
